...
public class ScoreboardHandler {
    ...
    public void addScoreBoardToPlayer(Player player) {
        ...
        scoreboard.registerNewTeam("actual-rank").addEntry("§4");
        scoreboard.registerNewTeam("players").addEntry("§5");
        ...
        Bukkit.getScheduler().runTaskTimer(Bukkit.getPluginManager().getPlugin("XSkyBlock"), () -> {
            ...
            scoreboard.getTeam("actual-rank").setPrefix("§aRank: §f" + userUtils.getRank(player.getName()));
